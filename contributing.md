...
It is better to count your dialogues and record them in the [topics file en/topics.md](en/topics.md) with your name. Later, your name will be transferred to a file related to team contributions.
...
To understand the structure of topics and dialogues, refer to the [conversations file en/conversations.txt](en/conversations.txt).
